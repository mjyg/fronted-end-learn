...
class XmlReporter {
    ...
    report(clones) {
      ...
      <duplication lines="${clone.duplicationA.end.line - clone.duplicationA.start.line}">
            <file path="${reports_1.getPath(clone.duplicationA.sourceId, this.options)}" line="${clone.duplicationA.start.line}">
              <codefragment><![CDATA[${clone.duplicationA.fragment.replace(/]]>/i, 'CDATA_END')}]]></codefragment>
            </file>
            <file path="${reports_1.getPath(clone.duplicationB.sourceId, this.options)}" line="${clone.duplicationB.start.line}">
